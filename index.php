...
<head>
    ...
    <style>
        /* DASHBOARD INTEGRATION - SYNC WITH QUIZ STYLE */
        body {
        ...
        input:focus, select:focus {
            border-color: #ee8331 !important;
            box-shadow: 0 0 0 4px rgba(238, 131, 49, 0.15) !important;
        }

        .bulk-btn.primary { background: #3b82f6; }
        .bulk-btn.success { background: #10b981; }
